...
import { changeAvatar, loginUser, logoutUser, refreshAccessToken, registerUser } from "../controllers/user.controller.js";
...
router.route("/update-avatar").post(changeAvatar)
